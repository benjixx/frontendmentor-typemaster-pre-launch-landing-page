...
<style>
	.image-keyboard {
		@apply mt-16 rounded-tl-[20px] rounded-bl-[20px] bg-cover bg-no-repeat;
		width: 351px;
		height: 331px;
	...
	.image-phone-and-keyboard {
		@apply inline-block relative ml-[-24px] mt-6 rounded-tr-[20px] rounded-br-[20px] bg-no-repeat;
		width: 107px;
		height: 193px;
		background: #f16718;
	}
	...
	.image-glass-and-keyboard {
		...
		@apply inline-block ml-5 rounded-[20px] bg-cover bg-no-repeat;
		width: 220px;
		height: 193px;
